...
cellDIVER allows for in-depth exploration of single-cell datasets without code. Functionality for the app is grouped into three tabs, the info tab, the plots tab, and the differential expression tab.
...
For more information on plot types, go to the "?" button and select "Single-Cell Visualizations". For information on all features in the plots tab, please see the [full documentation](https://amc-heme.github.io/cellDIVER/articles/full_documentation.html#plots-tab).
...
For more information, see the [full documentation](https://amc-heme.github.io/cellDIVER/articles/full_documentation.html#dge-tab).
