---
title: "cellDIVER Config App Documentation"
output: 
  html_document:
    toc: true
    toc_depth: 4
...
The cellDIVER config app is used to configure single-cell objects for display in the main browser. This vignette will walk through the operation of the app and detail all settings that may be adjusted.
